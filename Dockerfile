...
RUN set -x \
	...
	&& gpg --batch --keyserver-options http-proxy="http://proxylh.fi.uba.ar:8080" --keyserver hkps://keys.openpgp.org --recv-keys B42F6819007F00F88E364FD4036A9C25BF357DD4 \
...
# uid                  PostgreSQL Debian Repository
	...
	export GNUPGHOME="$(mktemp -d)"; \
	gpg --batch --keyserver-options http-proxy="http://proxylh.fi.uba.ar:8080" --keyserver ha.pool.sks-keyservers.net --recv-keys "$key"; \
